// auth.js — Albion v4 · "Executive Noir" přihlášení
// Stejné routy, stejná pojmenování polí/parametrů jako dřív (žádná změna
// v server.js je potřeba) — jen nový, klidnější centrovaný vzhled karty
// místo dřívějšího děleného hero layoutu.
    ...
    <style>
      *{margin:0;padding:0;box-sizing:border-box}
      :root{
        ...
        --oxblood-glow:rgba(142,36,54,0.30);
        --brass:#C9A227;
        --brass-bright:#E8C769;
      ...
      body::before{
        ...
        background:
          radial-gradient(ellipse 60% 45% at 50% 0%, rgba(201,162,39,0.07), transparent 60%),
          radial-gradient(ellipse 55% 55% at 100% 100%, rgba(142,36,54,0.09), transparent 60%);
      }
      ...
      .auth-crest img{width:64px;height:64px;object-fit:contain;filter:drop-shadow(0 0 22px rgba(142,36,54,0.55));animation:crestAmbient 4s ease-in-out infinite}
      ...
      .auth-alert{padding:0.8rem 0.95rem;background:rgba(142,36,54,0.10);border:1px solid var(--border-oxblood);border-left:2px solid var(--oxblood);font-size:0.76rem;margin-bottom:1.3rem;color:var(--oxblood-bright);font-family:var(--font-mono)}
      .auth-success{background:rgba(63,168,90,0.09);border-color:rgba(63,168,90,0.28);border-left-color:#3FA85A;color:#6ED08A}
      ...
      .auth-input{
        display:block;width:100%;padding:0.8rem 0.95rem;background:rgba(8,8,10,0.85);border:1px solid var(--border-brass);
      ...
      .boot-crest img{width:100%;height:100%;object-fit:contain;filter:drop-shadow(0 0 22px rgba(142,36,54,0.6));animation:crestAmbient 2s ease-in-out infinite}
      .boot-lines{width:min(560px,90vw);font-family:var(--font-mono);font-size:0.74rem;line-height:2.1;letter-spacing:0.03em;color:var(--brass);text-shadow:0 0 8px rgba(201,162,39,0.3);text-align:center;min-height:7em}
      ...
      .boot-progress{width:min(260px,80%);height:1px;background:rgba(201,162,39,0.15);position:relative;overflow:hidden}
      ...
      .reg-ceremony-seal{width:120px;height:120px;border-radius:50%;margin:0 auto 1.4rem;display:flex;align-items:center;justify-content:center;background:radial-gradient(circle at 35% 30%, var(--oxblood-bright), var(--oxblood) 55%, #3A0E17 100%);box-shadow:0 18px 40px rgba(0,0,0,0.6), inset 0 0 0 3px rgba(0,0,0,0.2);transform:scale(2.2) rotate(-18deg);opacity:0}
